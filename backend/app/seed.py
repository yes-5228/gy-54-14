...
def seed_demo_data():
    ...
    grades = [
        ...
        Grade(student=students[0], course_code="PS101", course_name="形势与政策", credit=0, score=85, semester="2025-2026-1", teacher="吴老师"),
        Grade(student=students[0], course_code="PE101", course_name="体育", credit=0, score=90, semester="2025-2026-1", teacher="郑老师"),
        ...
        Grade(student=students[1], course_code="PS101", course_name="形势与政策", credit=0, score=78, semester="2025-2026-1", teacher="吴老师"),
        Grade(student=students[2], course_code="DS101", course_name="数据分析基础", credit=3, score=88, semester="2025-2026-1", teacher="赵老师"),
        Grade(student=students[2], course_code="PS101", course_name="形势与政策", credit=0, score=92, semester="2025-2026-1", teacher="吴老师"),
        Grade(student=students[2], course_code="CAR101", course_name="职业发展与就业指导", credit=0, score=88, semester="2025-2026-2", teacher="孙老师"),
    ]
